...
def test_upload_obj_raises_value_error_on_empty_key(mocker: "MockerFixture") -> None:
...
def test_upload_obj_raises_value_error_on_leading_slash(mocker: "MockerFixture") -> None:
...
def test_upload_obj_calls_multipart_when_unseekable(
    ...
    ok = c.upload_obj(file_obj=Unseekable(), key="k")
